...
title: "HNH Robo Kit"
draft: false
description: "Embedded developer kit designed for students to learn robotics, sensors, and actuators hands-on."
tags: ["hardware", "education", "embedded"]
showDate: false
showAuthor: false
showReadingTime: false
showSummary: true
summary: "Embedded developer kit for students to learn robotics, sensors, and actuators through hands-on projects."
weight: 9
---
...
- **Modular Sensor Suite** — Plug-and-play ultrasonic, IR, IMU, and line-following sensor modules
- **Motor Control** — DC motor and servo drivers with PWM control for differential drive and steering
...
`ESP32` · `Arduino` · `KiCad` · `C/C++` · `Python`
